...
local table, sort, tinsert, tostring, loadstring = table, table.sort, table.insert, tostring, loadstring
module (...)
----------------------------------------------------------------------------
-- Serializes a table.
...
function dump(tab, outf, ind, pre)
	local sep_n, sep, _n = ",\n", ", ", "\n"
...
function serialize(input)
	local buf = {}
	dump(input or {}, function(s) table.insert(buf, s) end)
